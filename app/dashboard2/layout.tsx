...
const navItems = [
  ...
  { href: "/dashboard2/Inquiries", label: " Inquiries" },
  { href: "/dashboard2/Messages", label: " Messages" },
  { href: "/dashboard2/Reviews", label: " Reviews" },
  { href: "/dashboard2/Unpaid", label: " Unpaid Commission" },
  { href: "/dashboard2/Statistics", label: " Statistics" },
  { href: "/dashboard2/Users", label: " Users" },
  { href: "/dashboard2/Clinics", label: " Clinics" },
